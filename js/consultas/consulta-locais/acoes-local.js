...
$(document).ready(function () {
    ...
    jQuery('.btnEditar').click(function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: "processos/consulta-locais/consulta-locais-editar.php",
            data: { id: id },
    ...
    jQuery('.btnDesativar').click(function () {
        ...
        $("#dados_desativar").append("<b>Local:</b> " + id + " - " + nome);
    ...
    jQuery('#confirma_desativar').click(function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: "processos/consulta-locais/consulta-locais-desativar.php",
