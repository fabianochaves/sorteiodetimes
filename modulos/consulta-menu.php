...
<head>
    ...
    <title><?php echo $_SESSION['nome_sistema']; ?> | Consulta de Menu</title>
...
<body>
    <?php include('processos/consulta-menu/modals.php')?>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <script src="js/consultas/consulta-menu/acoes-filtro.js"></script>
